...
import com.smona.app.guaika.video.adapter.RecommendAdapter;
...
public abstract class AbsRecommendFragment extends
        BaseFragment<SwipeRefreshLayout, List<VideoData>, VideoMvpView, AbsRecommendPresenter>
    ...
    public void setData(List<VideoData> data) {
        if (mVideoAdapter == null) {
            mVideoAdapter = new RecommendAdapter(mContext, data);
