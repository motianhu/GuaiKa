package com.smona.app.guaika.more.adapter;
...
public class MoreAdapter extends HeaderAndFooterAdapter<VideoData> {

    private Context mContext;

    public MoreAdapter(Context context, List<VideoData> list) {
        super(list);
        mContext = context;
    }
