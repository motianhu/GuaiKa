...
import com.smona.app.guaika.more.adapter.MoreAdapter;
...
public abstract class AbsMoreFragment extends
        BaseFragment<SwipeRefreshLayout, List<VideoData>, VideoMvpView, AbsMorePresenter>
    ...
    private MoreAdapter mVideoAdapter;
    ...
    public void setData(List<VideoData> data) {
        if (mVideoAdapter == null) {
            mVideoAdapter = new MoreAdapter(mContext, data);
